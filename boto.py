...
# Create output directory for Spring Boot resource location
echo "[INFO] Creating src/main/resources directory"
mkdir -p "${WORKSPACE}/src/main/resources"
if [ $? -eq 0 ]; then
  echo "[INFO] Directory created successfully"
  echo "[DEBUG] Directory contents:"
  ls -la "${WORKSPACE}/src/main/resources"
else
...
# Verify file was created successfully
if [ -f "$OUTPUT" ]; then
  echo "[INFO] Metadata file created successfully"
